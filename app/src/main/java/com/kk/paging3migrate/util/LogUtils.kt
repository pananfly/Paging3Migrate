package com.kk.paging3migrate.util
...
object LogUtils {
    ...
    fun json(json: String) {
        ...
        try {
            ...
            error(
                "${e.cause?.message}${System.getProperty(
                    "line.separator"
                )}$json"
            )
        }
    ...
    fun wtf(msg: Any?) {
        ...
        if (msg == null)
            ...
            is Int, Long, Float, Double, Boolean -> Log.wtf(
                className,
                createLog("$msg")
            )
            is String -> Log.wtf(
    ...
    fun error(msg: Any?) {
        ...
        if (msg == null)
            ...
            is Int, Long, Float, Double, Boolean -> Log.e(
                className,
                createLog("$msg")
            )
            is String -> Log.e(
    ...
    fun warn(msg: Any?) {
        ...
        if (msg == null)
            ...
            is Int, Long, Float, Double, Boolean -> Log.w(
                className,
                createLog("$msg")
            )
            is String -> Log.w(
    ...
    fun info(msg: Any?) {
        ...
        if (msg == null)
            ...
            is Int, Long, Float, Double, Boolean -> Log.i(
                className,
                createLog("$msg")
            )
            is String -> Log.i(
    ...
    fun debug(msg: Any?) {
        ...
        if (msg == null)
            ...
            is Int, Long, Float, Double, Boolean -> Log.d(
                className,
                createLog("$msg")
            )
            is String -> Log.d(
    ...
    fun verbose(msg: Any?) {
        ...
        if (msg == null)
            ...
            is Int, Long, Float, Double, Boolean -> Log.v(
                className,
                createLog("$msg")
            )
            is String -> Log.v(
